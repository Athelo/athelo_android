        ...
        AnimatedVisibility(
            ...
            Card(
                ...
                Box(
                    ...
                    IconButton(
                        onClick = { viewModel.handleEvent(com.i2asolutions.athelo.presentation.ui.patient.symptomAdd.AddSymptomEvent.CloseButtonClick) },
                ...
                InputTextField(
                    ...
                    onChange = {
                        viewModel.handleEvent(
                            com.i2asolutions.athelo.presentation.ui.patient.symptomAdd.AddSymptomEvent.InputValueChanged(
                    ...
                    keyboardActions = KeyboardActions(onDone = {
                        if (state.enableSaveButton)
                            viewModel.handleEvent(com.i2asolutions.athelo.presentation.ui.patient.symptomAdd.AddSymptomEvent.SaveButtonClick)
                    }),
