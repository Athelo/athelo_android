...
import com.athelohealth.mobile.extensions.displayAsChatDate
import com.athelohealth.mobile.extensions.displayAsChatSeparator
...
import com.athelohealth.mobile.utils.createMockConversation
import com.athelohealth.mobile.utils.createMockMessages
import com.athelohealth.mobile.utils.createMockUser
import java.util.*
...
//            isMuted = isMuted
        ...
        Box {
            ...
            Column(modifier = Modifier.navigationBarsPadding()) {
                ...
                if (yourConversation || isPrivateChat) {
...
@Composable
private fun SystemMessage(message: ConversationInfo.ConversationMessage) {
...
@Composable
private fun HelloMessage(handleEvent: (ChatEvent) -> Unit) {
...
private fun shouldAddDaySeparator(
    nextMessage: ConversationInfo.ConversationMessage?,
    message: ConversationInfo.ConversationMessage?,
    canLoadMore: Boolean
): Boolean {
