...
fun ActivityScreen(viewModel: ActivityViewModel) {
    ...
    BoxScreen(
        ...
        if (state.value.showNotConnected) {
            ...
            ActivityScreen(
                ...
                currentUser = state.value.currentUser,
                topHint = state.value.topHint,
                steps = state.value.stepsInformation,
                activity = state.value.activityInformation,
                heartRate = state.value.heartRateInformation,
                hrv = state.value.hrvInformation
            )
        }
    }
}
