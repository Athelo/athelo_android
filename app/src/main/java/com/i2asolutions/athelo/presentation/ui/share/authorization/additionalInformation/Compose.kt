    ...
    BoxScreen(
        ...
        Column {
            ...
            InputTextField(
                ...
                onChange = {
                    viewModel.handleEvent(
                        com.i2asolutions.athelo.presentation.ui.share.authorization.additionalInformation.AdditionalInfoEvent.InputValueChanged(
            ...
            MainButton(
                ...
                onClick = {
                    focusController.clearFocus()
                    viewModel.handleEvent(com.i2asolutions.athelo.presentation.ui.share.authorization.additionalInformation.AdditionalInfoEvent.SaveButtonClick)
                },
